 ...
 */
class KekooAdmin extends Framework implements FrameworkInterface
{
    /**
     ...
     * @return Element
     */
    public function createTabletext(Field $field)
    {
        return Element::create('input_text', $field->getValue(), $field->getAttributes());
    }
